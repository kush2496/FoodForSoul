package com.myProject.FoodForSoul.controller;

import com.myProject.FoodForSoul.model.Appointment;
import com.myProject.FoodForSoul.service.AppointmentService;
...
public class FitnessAppointment {
    ...
    public FitnessAppointment() {
    }

    public FitnessAppointment(AppointmentService appointmentService) {
